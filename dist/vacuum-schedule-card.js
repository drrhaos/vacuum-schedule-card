      ...
      <div class="control-panel">
        ...
        <div class="control-row rooms-row">
          ${r.length>0?H`
            ...
            ${r.map(t=>{const e=this._currentCleaningRooms.includes(t.id),o=this.selectedRooms.includes(t.id);return H`
                <ha-card 
