        ...
        <div class="control-row rooms-row">
          ${i.length>0?H`
            ...
            ${i.map(t=>H`
              ...
              >
                <span class="button-content">
                  <span class="button-icon">${this._renderRoomIcon(t)}</span>
